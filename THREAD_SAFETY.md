...
**Note**: Thread safety of the following functions depends on the support of atomic operations (`atomic_store` and `atomic_load`) on the specific OS. If it is supported then they all are thread-safe (except rpma_conn_req_connect).
