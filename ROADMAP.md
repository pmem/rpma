# **The librpma roadmap [21/04/2020]**
This document presents the librpma library roadmap as it shaped on 21/04/2020. It lists high-level features that are going to be released with the library release 0.9 and features that are planned to be developed later.
...
:black_square_button:|Log prefix|Enable a custom, user-defined prefix in log messages|09/18/2020
...
# **The librpma fio engine roadmap [21/04/2020]**
