...
#        run-all-on-SoftRoCE.sh <binary-examples-directory> [IP_address] [--valgrind]
#        run-all-on-SoftRoCE.sh <binary-examples-directory> [--valgrind] [IP_address] [port]
#
...
if [ "$BIN_DIR" == "" ]; then
	...
	echo "       run-all-on-SoftRoCE.sh <binary-examples-directory> [IP_address] [--valgrind]"
	echo "       run-all-on-SoftRoCE.sh <binary-examples-directory> [--valgrind] [IP_address] [port]"
