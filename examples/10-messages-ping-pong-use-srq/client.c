...
/*
 * client.c -- a client of the messages-ping-pong-use-srq example
 *
...
#include "messages-ping-pong-use-srq-common.h"
...
main(int argc, char *argv[])
{
	...
	static struct rpma_conn_cfg cfg  = {
		.use_srq = true,
	...
	if ((ret = client_connect(peer, addr, port, NULL, &conn, &cfg)))
		goto err_mr_dereg;
