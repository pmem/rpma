...
function usage()
{
	...
	echo "export CUSTOM_PART_OF_FILENAME=free_text_to_be_added_to_every_file_name"
	echo
	echo "Debug:"
...
function benchmark_one() {
	...
	OP=$3
	MODE=$4
	if [ -n "$CUSTOM_PART_OF_FILENAME" ]; then
		COMMENT="__$CUSTOM_PART_OF_FILENAME""__"
	fi
