...
function benchmark_one() {
	...
	bw-bs)
		...
		ITERATIONS=(48336720 48336720 34951167 24475088 23630690 8299603 5001135 5001135 5001135)
	...
	lat)
		...
		DEPTH=1
		# values measured empirically, so that duration was ~60s
		ITERATIONS=(27678723 27678723 20255739 16778088 11423082 8138946 6002473 6002473 6002473)
