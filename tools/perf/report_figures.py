...
"""A script generating images from data collected by the `report_bench` (EXPERIMENTAL)
...
When this script is done you probably will continue processing the results with `report_create`.
"""
...
def generate_figures(args: argparse.Namespace) -> None:
    """Restore the `lib.bench.Bench` object, check whether it has completed the ordered benchmarks.
