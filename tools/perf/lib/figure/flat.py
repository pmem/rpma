...
A 'flat' list a figures is a list where a single element on this list represents
exactly one output figure with all series representing exactly one series
of benchmarks.
