...
#
# Figure.py -- generate a figure-related products (EXPERIMENTAL)
#
...
class Figure:
    ...
    def prepare_series(self, result_dir):
        ...
        for series in self.series:
            ...
            # it is assumed each row have the same names of columns
            keys = rows[0].keys()
    ...
    def _label(self, column):
        """Translate the name of a column to a label with an unit"""
        # XXX
        return arg
