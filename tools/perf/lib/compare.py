...
class Comparison:
    ...
    def prepare_series(self) -> None:
        ...
        are browsed in order to fall all occurances of the figure.
        All occurances of the figure are compiled into a single figure
        ...
        - the figure exists in two `lib.bench.Bench` instances named: Alfa and
          Beta.
        - The resulting figure will be have the follwing series:
