...
/*
 * rpma_cq_wait -- wait for a completion from the rpma_cq object
 *
 * ASSUMPTIONS
 * - cq != NULL
 */
...
/*
 * rpma_cq_get -- receive an operation completion from the rpma_cq object
 *
 * ASSUMPTIONS
 * - cq != NULL && cmpl != NULL
 */
...
/*
 * rpma_cq_delete -- destroy the CQ and completion channel and then
 ...
 *
 * ASSUMPTIONS
 * - cq != NULL && ibv_cq_ptr != NULL
 */
int
rpma_cq_get_ibv_cq(struct rpma_cq *cq, struct ibv_cq **ibv_cq_ptr)
{
	*ibv_cq_ptr = cq->cq;
