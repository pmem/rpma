 ...
 * for details. All operations generate completion on error. The operations
 * posted with the **RPMA_F_COMPLETION_ALWAYS** flag also generate a completion
 * on success.
 ...
 *
 * DESCRIPTION
 * rpma_cq_get_fd() gets the completion file descriptor of the connection.
 *
 * RETURN VALUE
