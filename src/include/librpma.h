...
/*
 * For the description of all fields of 'struct rpma_completion'
 * see the DESCRIPTION section of the rpma_cq_get_completion()'s manual.
 */
 ...
 *
 * The fields of 'struct rpma_completion' have the following meaning:
