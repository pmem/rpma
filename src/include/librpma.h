 ...
 * and no remote address has to be specified on the local side.
 *
 ...
 * - rpma_conn_req_recv() also initiates the receive operation and prepares
 *   a buffer for a message sent from other side of the connection,
 *   but it may be used before the connection is established.
 *
 * COMPLETIONS
 *
