 ...
 * - RPMA_MR_USAGE_READ_SRC - memory used as source for read operation
 * - RPMA_MR_USAGE_READ_DST - memory used as destination for read operation
 * - RPMA_MR_USAGE_WRITE_SRC - memory used as source for write operation
 * - RPMA_MR_USAGE_WRITE_DST - memory used as destination for write operation
 ...
 * - RPMA_OP_READ - RPMA read operation
 * - RPMA_OP_WRITE - RPMA write operation
 * - RPMA_OP_FLUSH - RPMA flush operation
 * - RPMA_OP_SEND - RPMA send operation
 * - RPMA_OP_RECV - RPMA receive operation
 *
 * RETURN VALUE
