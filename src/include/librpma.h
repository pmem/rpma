 ...
 *
 * SEE ALSO
 * rpma_conn_cfg_new(3), rdma_conn_wait(3), rpma_conn_cfg_set_compl_channel(3),
 * librpma(7) and https://pmem.io/rpma/
 */
int rpma_conn_cfg_get_compl_channel(const struct rpma_conn_cfg *cfg,
		bool *shared);
 ...
 * is shared by CQ and RCQ. If this function is not called, the shared has
 * the default value (false) set by rpma_conn_cfg_new(3).
 *
 * RETURN VALUE
 ...
 *
 * SEE ALSO
 * rpma_conn_cfg_new(3), rdma_conn_wait(3), rpma_conn_cfg_get_compl_channel(3),
 * librpma(7) and https://pmem.io/rpma/
 */
