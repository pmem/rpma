 ...
 * is shared by CQ and RCQ. If this function is not called,
 * the completion event channel is not shared by CQ and RCQ by default
 * (it is set by rpma_conn_cfg_new(3)).
 *
 * RETURN VALUE
