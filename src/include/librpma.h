...
#define RPMA_MR_USAGE_FLUSHABLE_VISIBILITY	(1 << 4)
#define RPMA_MR_USAGE_FLUSHABLE_PERSISTENCY	(1 << 5)
#define RPMA_MR_USAGE_SEND			(1 << 6)
#define RPMA_MR_USAGE_RECV			(1 << 7)

#define RPMA_MR_USAGE_FLUSHABLE \
	(RPMA_MR_USAGE_FLUSHABLE_VISIBILITY | \
	RPMA_MR_USAGE_FLUSHABLE_PERSISTENCY)
