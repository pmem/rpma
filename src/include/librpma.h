 ...
 * Remote Memory Access and Messaging. Both available over a connection
 * established between two Peers. Both of these schemes can make use of PMem
 * as well as DRAM for the sake of building efficient and scalable Remote PMem
