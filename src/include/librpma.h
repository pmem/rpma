...
/** 3
 * rpma_conn_get_compl_fd -- get a file descriptor of
 *  the completion channel from the connection
 *
 * SYNOPSIS
 *
 *	#include <librpma.h>
 ...
 *
 * DESCRIPTION
 * rpma_conn_get_compl_fd() gets a file descriptor of
 *  the completion channel from the connection.
 *
 * RETURN VALUE
 ...
 *
 * - RPMA_E_INVAL - conn or fd is NULL
 * - RPMA_E_NOT_SHARED_CHNL - the completion channel is NULL
 *
 * SEE ALSO
