 ...
 * - RPMA_E_PROVIDER - rdma_create_event_channel(3) failed
 * - RPMA_E_PROVIDER - rdma_create_id(3) failed
 * - RPMA_E_PROVIDER - rdma_getaddrinfo(3) failed
 * - RPMA_E_PROVIDER - rdma_listen(3) failed
 * - RPMA_E_NOMEM - out of memory
 */
