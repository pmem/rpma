 ...
 *
 * CLIENT OPERATION
 * A client is an active side of the process of establishing a connection.
 * The process after creating a connection request object is common for both
 * sides. A role of the peer during the process of establishing connection
 ...
 *
 * The client to establish a connection has to perform the following steps:
 *
 ...
 *
 * The client to close a connection has to perform the following steps:
 *
 ...
 *
 * DESCRIPTION
 * rpma_conn_req_connect() initiate processing the connection requests both
