 ...
 *
 * To get the required size of the buffer please see the
 ...
 * remote peer.
 *
 * The buff_size value should be equal to the value returned by
 * rpma_mr_serialize_get_size() on the node where the memory region has been
 * serialized.
 *
 * rpma_mr_deserialize() does not change the buff contents regardless of the
 * function result.
 *
 * ERRORS
