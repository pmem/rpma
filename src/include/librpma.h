 ...
 * SEE ALSO
 *
 * rpma_peer_cfg_delete(3), rpma_peer_cfg_from_descriptor(3),
 * rpma_peer_cfg_get_descriptor(3), rpma_peer_cfg_get_descriptor_size(3),
 * rpma_peer_cfg_get_direct_write_to_pmem(3),
 * rpma_peer_cfg_set_direct_write_to_pmem(3), rpma_conn_apply_remote_peer_cfg(3)
 ...
 * SEE ALSO
 *
 * rpma_peer_cfg_new(3), rpma_peer_cfg_get_direct_write_to_pmem(3)
 * rpma_peer_cfg_get_descriptor(3), rpma_conn_apply_remote_peer_cfg(3) and
 * https://pmem.io/rpma/
 */
int rpma_peer_cfg_set_direct_write_to_pmem(struct rpma_peer_cfg *pcfg,
		bool supported);
 ...
 * SEE ALSO
 *
 * rpma_peer_cfg_new(3), rpma_peer_cfg_set_direct_write_to_pmem(3),
 * rpma_peer_cfg_from_descriptor(3) and https://pmem.io/rpma/
 */
 ...
 * SEE ALSO
 *
 * rpma_peer_cfg_new(3), rpma_peer_cfg_from_descriptor(3) and
 * https://pmem.io/rpma/
 */
 ...
 * SEE ALSO
 *
 * rpma_peer_cfg_new(3), rpma_peer_cfg_get_descriptor(3) and
 * https://pmem.io/rpma/
 */
int
 ...
 * SEE ALSO
 *
 * rpma_peer_cfg_new(3), rpma_peer_cfg_get_descriptor(3),
 * rpma_conn_apply_remote_peer_cfg(3) and https://pmem.io/rpma/
 */
int rpma_peer_cfg_from_descriptor(void *desc, size_t desc_size,
		struct rpma_peer_cfg **pcfg_ptr);
 ...
 * SEE ALSO
 *
 * rpma_utils_get_ibv_context(3), rpma_peer_delete(3) and
 * https://pmem.io/rpma/
 */
