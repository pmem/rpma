 ...
 *	        enum rpma_info_side side, struct ibv_context **dev);
 *
 * DESCRIPTION
 ...
 *
 * - RPMA_E_INVAL - addr or dev is NULL or side is unknown
 ...
 */
int rpma_utils_get_ibv_context(const char *addr, enum rpma_info_side side,
