 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_set_timeout() sets connection establishment timeout.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_get_timeout() gets connection establishment timeout.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_set_cq_size() sets CQ size for the connection.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_get_cq_size() gets CQ size for the connection.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_set_sq_size() sets SQ size for the connection.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_get_sq_size() gets SQ size for the connection.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_set_rq_size() sets RQ size for the connection.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_cfg_get_rq_size() gets RQ size for the connection.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_apply_remote_peer_cfg() applys remote peer cfg for the connection.
 *
 * RETURN VALUE
 ...
 *
 * DESCRIPTION
 * rpma_conn_req_delete() deletes the connection request both
