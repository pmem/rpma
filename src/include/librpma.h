 ...
 * rpma_peer_cfg_delete(3), rpma_peer_cfg_from_descriptor(3),
 * rpma_peer_cfg_get_descriptor(3), rpma_peer_cfg_get_descriptor_size(3),
 * rpma_peer_cfg_get_direct_write_to_pmem(3), rpma_peer_cfg_new(3) and
 * https://pmem.io/rpma/
 */
int rpma_peer_cfg_set_direct_write_to_pmem(struct rpma_peer_cfg *pcfg,
		bool supported);
 ...
 * rpma_peer_cfg_delete(3), rpma_peer_cfg_from_descriptor(3),
 * rpma_peer_cfg_get_descriptor(3), rpma_peer_cfg_get_descriptor_size(3),
 * rpma_peer_cfg_new(3), rpma_peer_cfg_set_direct_write_to_pmem(3) and
 * https://pmem.io/rpma/
 */
 ...
 * SEE ALSO
 *
 * rpma_peer_cfg_delete(3), rpma_peer_cfg_get_descriptor(3),
 * rpma_peer_cfg_get_descriptor_size(3),
 * rpma_peer_cfg_get_direct_write_to_pmem(3), rpma_peer_cfg_new(3),
 * rpma_peer_cfg_set_direct_write_to_pmem(3) and https://pmem.io/rpma/
 */
