 ...
 * (since it never fails), so the unit tests cannot test this path.
 * When this function stops being static, the unit tests
 * for the failing path of the snprintf() function should be added.
 *
 * ASSUMPTIONS:
