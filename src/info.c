 ...
 */
int
rpma_info_resolve_addr(struct rdma_cm_id *id, struct rpma_info *info)
{
...
/*
 * rdma_info_bind_addr -- bind the ID to address
 */
int
rdma_info_bind_addr(struct rdma_cm_id *id, struct rpma_info *info)
{
	ASSERTeq(info->side, RPMA_INFO_PASSIVE);
