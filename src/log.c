...
rpma_log_init()
{
	...
	do {
		ret = rpma_log_set_function(RPMA_LOG_USE_DEFAULT_FUNCTION);
...
#define __sync_bool_compare_and_swap mock__sync_bool_compare_and_swap__function
#endif
...
#define __sync_bool_compare_and_swap mock__sync_bool_compare_and_swap__threshold
#endif
