...
/*
 * rpma_log_set -- set the log function pointer either to a user-provided
 * function pointer or to the default logging function
 */
void
...
/*
 * rpma_log_syslog_get_threshold -- get the log level threshold
 */
int
