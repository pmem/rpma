...
* Platform and CPU related [[1]][opt-part-1]
    * Disable lower CPU power states: C-states[[2]][power-states], C1E, and memory and PCI-e power saving states. Settings vary from vendor to vendor so some of them may not be available for you.
...
* PMem-related
    * configure maximum available operating power for your PMem devices **[XXX source and details are missing]**. **Note**: Different sizes of PMem devices have different performance capabilites. If it is important for you, pick the right one for your application. [[3]][pmem-200-brief]

### Not yet confirmed [[1]][opt-part-1]

* Ensure that *Intel® Turbo Boost*[[4]][turbo] is on.
...
* [2] [Intel: Power Management States: P-States, C-States, and Package C-States][power-states]
* [3] [Intel® Optane™ Persistent Memory 200 Series Brief][pmem-200-brief]
* [4] [Intel® Turbo Boost Technology 2.0 - Higher Performance When You Need It Most][turbo]
