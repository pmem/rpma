...
# Generates cstyle-$name and cformat-$name targets and attaches them
# as dependencies of global "cformat" target.
# cstyle-$name target verifies C++ style of files in current source dir.
# cformat-$name target reformats files in current source dir.
...
function(add_cstyle name)
	...
	if(${ARGC} EQUAL 1)
		...
		add_custom_target(cformat-${name}
			COMMAND ${PERL_EXECUTABLE}
				${CMAKE_SOURCE_DIR}/utils/cstyle
				${CLANG_FORMAT}
				format
	...
	add_dependencies(cformat cformat-${name})
endfunction()
