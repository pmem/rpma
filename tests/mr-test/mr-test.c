...
test_reg__failed_E_NOMEM(void **unused)
{
	...
	mr_reg_args.access = MOCK_ACCESS;
...
test_dereg__failed_E_PROVIDER(void **pprestate)
{
	...
	assert_int_equal(ret, MOCK_OK);
	struct rpma_mr_local *mr = *pprestate;
