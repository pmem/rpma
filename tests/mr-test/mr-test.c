...
#define MOCK_USAGE	MOCK_USAGE_3
...
/*
 * test_reg__NULL_mr -- NULL mr is invalid
 */
static void
test_reg__NULL_mr(void **unused)
{
	/* run test */
...
/*
 * test_reg__NULL_peer_ptr_mr -- NULL peer, ptr and mr are invalid
 */
static void
test_reg__NULL_peer_ptr_mr(void **unused)
{
	/* run test */
...
/*
 * setup__reg_success_usage_common -- common function for creating
 * a local memory registration object
 */
static int
setup__reg_success_usage_common(void **mr_ptr, int usage)
{
	/* configure mocks */
...
/*
 * setup__reg_success_usage_0 -- create a local memory registration object
 */
static int
setup__reg_success_usage_0(void **mr_ptr)
{
	return setup__reg_success_usage_common(mr_ptr, MOCK_USAGE_0);
}

/*
 * setup__reg_success_usage_1 -- create a local memory registration object
 */
static int
setup__reg_success_usage_1(void **mr_ptr)
{
	return setup__reg_success_usage_common(mr_ptr, MOCK_USAGE_1);
}

/*
 * setup__reg_success_usage_2 -- create a local memory registration object
 */
static int
setup__reg_success_usage_2(void **mr_ptr)
{
	return setup__reg_success_usage_common(mr_ptr, MOCK_USAGE_2);
}

/*
 * setup__reg_success_usage_3 -- create a local memory registration object
 */
static int
setup__reg_success_usage_3(void **mr_ptr)
{
	return setup__reg_success_usage_common(mr_ptr, MOCK_USAGE_3);
}
...
/*
 * test_reg_dereg__success_usage_0 -- happy day scenario
 */
static void
test_reg_dereg__success_usage_0(void **unused)
{
	/*
	 * The whole thing is done by setup__reg_success_usage_0()
	 * and teardown__dereg_success().
	 */
}

/*
 * test_reg_dereg__success_usage_1 -- happy day scenario
 */
static void
test_reg_dereg__success_usage_1(void **unused)
{
	/*
	 * The whole thing is done by setup__reg_success_usage_1()
	 * and teardown__dereg_success().
	 */
}

/*
 * test_reg_dereg__success_usage_2 -- happy day scenario
 */
static void
test_reg_dereg__success_usage_2(void **unused)
{
	/*
	 * The whole thing is done by setup__reg_success_usage_2()
	 * and teardown__dereg_success().
	 */
}

/*
 * test_reg_dereg__success_usage_3 -- happy day scenario
 */
static void
test_reg_dereg__success_usage_3(void **unused)
{
	/*
	 * The whole thing is done by setup__reg_success_usage_3()
	 * and teardown__dereg_success().
	 */
}
 ...
 */
static void
test_dereg__failed_E_PROVIDER(void **unused)
{
	 ...
	 */
	(void) setup__reg_success_usage_3((void **)&mr);
...
main(int argc, char *argv[])
{
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test(test_reg__NULL_mr),
		cmocka_unit_test(test_reg__NULL_peer_ptr_mr),
		...
		cmocka_unit_test_setup_teardown(test_reg_dereg__success_usage_0,
			setup__reg_success_usage_0, teardown__dereg_success),
		cmocka_unit_test_setup_teardown(test_reg_dereg__success_usage_1,
			setup__reg_success_usage_1, teardown__dereg_success),
		cmocka_unit_test_setup_teardown(test_reg_dereg__success_usage_2,
			setup__reg_success_usage_2, teardown__dereg_success),
		cmocka_unit_test_setup_teardown(test_reg_dereg__success_usage_3,
			setup__reg_success_usage_3, teardown__dereg_success),

		/* rpma_mr_dereg() unit tests */
		cmocka_unit_test(test_dereg__NULL_mr_ptr),
		cmocka_unit_test(test_dereg__NULL_mr),
		cmocka_unit_test(test_dereg__failed_E_PROVIDER),
	};
