	...
	size_t length, int access)
{
	...
	assert_int_equal(access, MOCK_ACCESS);
 ...
 */
static int
setup__reg_success(void **mr_ptr)
{
	/* configure mocks */
...
test_dereg__failed_E_PROVIDER(void **unused)
{
	 ...
	 */
	(void) setup__reg_success((void **)&mr);
...
main(int argc, char *argv[])
{
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_reg_dereg__success,
