...
static struct state states[] = {
	...
	{1, MOCK_USAGE_0, MOCK_ACCESS_0},
	/* values used in test_reg_dereg__success called with (states + 2) */
	{2, MOCK_USAGE_1, MOCK_ACCESS_1},
	/* values used in test_reg_dereg__success called with (states + 3) */
	{3, MOCK_USAGE_2, MOCK_ACCESS_2},
	/* values used in test_reg_dereg__success called with (states + 4) */
	{4, MOCK_USAGE_3, MOCK_ACCESS_3},
	/* values used in test_dereg__failed_E_PROVIDER */
	/* called with (states + 5) */
	{5, MOCK_USAGE, MOCK_ACCESS},
};
