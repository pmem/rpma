...
/*
 * test_set_backtrace_level -- is it possible to set all backtrace logging levels?
 */
void test_set_backtrace_level(void **unused);

/*
 * test_set_backtrace_level_invalid -- do out of scope backtrace logging levels rejected?
 */
void test_set_backtrace_level_invalid(void **unused);
