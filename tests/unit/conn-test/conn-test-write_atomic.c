...
/*
 * write_atomic__conn_dst_src_NULL_flags_0 -- NULL conn, dst, src
 * and flags == 0 are invalid
 */
static void
write_atomic__conn_dst_src_NULL_flags_0(void **unused)
{
	/* run test */
...
const struct CMUnitTest tests_write_atomic[] = {
	...
	cmocka_unit_test(write_atomic__conn_dst_src_NULL_flags_0),
