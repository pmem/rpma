...
/*
 * get__cq_NULL - cq NULL is invalid
 */
static void
get__cq_NULL(void **unused)
{
	/* run test */
	struct rpma_completion cmpl = {0};
	int ret = rpma_cq_get(NULL, &cmpl);
...
/*
 * get__cmpl_NULL - cmpl NULL is invalid
 */
static void
get__cmpl_NULL(void **cq_ptr)
{
	struct rpma_cq *cq = *cq_ptr;

	/* run test */
	int ret = rpma_cq_get(cq, NULL);
