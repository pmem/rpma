...
/*
 * flush-apm_request.c -- unit tests of the flush module
 *
 * API covered:
 * - rpma_flush_apm_request
 */
...
/*
 * apm_request__success -- rpma_flush_apm_request() success
 */
static void
apm_request__success(void **fstate_ptr)
{
	/* configure mocks */
...
main(int argc, char *argv[])
{
	...
	const struct CMUnitTest tests[] = {
		/* rpma_flush_apm_request() unit tests */
		cmocka_unit_test_setup_teardown(apm_request__success,
