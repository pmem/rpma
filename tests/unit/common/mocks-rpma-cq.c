...
/*
 * rpma_ibv_comp_channel_create -- rpma_ibv_comp_channel_create() mock
 */
int
rpma_ibv_comp_channel_create(struct ibv_context *ibv_ctx,
...
/*
 * rpma_ibv_comp_channel_destroy -- rpma_ibv_comp_channel_destroy() mock
 */
int
rpma_ibv_comp_channel_destroy(struct ibv_comp_channel *channel)
{
	/*
	 * XXXXXX write the full mock for this function.
	 */
