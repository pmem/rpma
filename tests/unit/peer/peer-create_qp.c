 ...
 */
static void
create_qp__id_NULL(void **cstate_ptr)
{
	struct peer_prestate *cstate = *cstate_ptr;

	/* run test */
	int ret = rpma_peer_create_qp(cstate->peer, NULL, MOCK_RPMA_CQ, NULL,
 ...
 */
static void
create_qp__cq_NULL(void **cstate_ptr)
{
	struct peer_prestate *cstate = *cstate_ptr;

	/* run test */
	int ret = rpma_peer_create_qp(cstate->peer, MOCK_CM_ID, NULL,
			NULL, MOCK_CONN_CFG_DEFAULT);
 ...
 */
static void
create_qp__rdma_create_qp_ERRNO(void **cstate_ptr)
{
	struct peer_prestate *cstate = *cstate_ptr;
	...
	for (int i = 0; i < num_rcqs; i++) {
		...
		/* run test */
		int ret = rpma_peer_create_qp(cstate->peer, MOCK_CM_ID, MOCK_RPMA_CQ,
 ...
 */
static void
create_qp__success(void **cstate_ptr)
{
	struct peer_prestate *cstate = *cstate_ptr;
