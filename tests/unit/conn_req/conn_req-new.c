...
static const struct CMUnitTest test_new[] = {
	...
	{"new__peer_create_qp_ERRNO__without_rcq", new__peer_create_qp_ERRNO,
		NULL, NULL, NULL},
	{"new__peer_create_qp_ERRNO__with_rcq", new__peer_create_qp_ERRNO,
		NULL, NULL, &Conn_req_new_conn_cfg_custom},
	{"new__malloc_ERRNO__without_rcq", new__malloc_ERRNO, NULL, NULL,
		NULL},
	{"new__malloc_ERRNO__with_rcq", new__malloc_ERRNO, NULL, NULL,
		&Conn_req_new_conn_cfg_custom},
	{"new__malloc_ERRNO_subsequent_ERRNO2__without_rcq",
		new__malloc_ERRNO_subsequent_ERRNO2, NULL, NULL, NULL},
	{"new__malloc_ERRNO_subsequent_ERRNO2__with_rcq",
		new__malloc_ERRNO_subsequent_ERRNO2, NULL, NULL,
		&Conn_req_new_conn_cfg_custom},
	{"new__success__without_rcq", new__success,
		setup__conn_req_new, teardown__conn_req_new, NULL},
