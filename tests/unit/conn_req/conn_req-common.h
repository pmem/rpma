...
#define CONN_REQ_NEW_TEST_SETUP_TEARDOWN_WITH_AND_WITHOUT_SRQ_RCQ(test_func, \
		setup_func, teardown_func) \
	{#test_func "__without_srq_rcq", (test_func), \
		(setup_func), (teardown_func), \
		&Conn_req_new_conn_cfg_custom_without_srq_rcq}, \
	{#test_func "__with_srq_rcq", (test_func), (setup_func), \
		(teardown_func), &Conn_req_new_conn_cfg_custom_with_srq_rcq}
#define CONN_REQ_NEW_TEST_WITH_AND_WITHOUT_SRQ_RCQ(test_func) \
	CONN_REQ_NEW_TEST_SETUP_TEARDOWN_WITH_AND_WITHOUT_SRQ_RCQ(test_func, \
		NULL, NULL)
...
#define CONN_REQ_TEST_SETUP_TEARDOWN_WITH_AND_WITHOUT_SRQ_RCQ(test_func, \
		setup_func, teardown_func) \
	{#test_func "__without_srq_rcq", (test_func), (setup_func), \
		(teardown_func), &Conn_req_conn_cfg_custom_without_srq_rcq}, \
	{#test_func "__with_rcq", (test_func), (setup_func), \
		(teardown_func), &Conn_req_conn_cfg_custom_with_srq_rcq}
...
extern struct conn_req_test_state Conn_req_conn_cfg_custom_with_srq_rcq;
...
extern struct conn_req_new_test_state
	Conn_req_new_conn_cfg_custom_without_srq_rcq;
extern struct conn_req_new_test_state
	Conn_req_new_conn_cfg_custom_with_srq_rcq;
