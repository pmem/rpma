...
/*
 * from_cm_event__create_qp_ERRNO_subsequent_ERRNO2 -- rpma_cq_delete()
 * fails with MOCK_ERRNO2 after rpma_peer_create_qp() failed with MOCK_ERRNO
 */
static void
...
/*
 * from_cm_event__malloc_ERRNO_subsequent_ERRNO2 -- rpma_cq_delete()
 * fails with MOCK_ERRNO2 after malloc() failed with MOCK_ERRNO
 */
static void
