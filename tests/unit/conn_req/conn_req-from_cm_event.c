...
{
	struct conn_req_test_state *cstate = &Conn_req_conn_cfg_default;
...
static const struct CMUnitTest test_from_cm_event[] = {
	...
	{"from_cm_event__peer_create_qp_ERRNO__without_rcq",
		from_cm_event__peer_create_qp_ERRNO, NULL, NULL, NULL},
	{"from_cm_event__peer_create_qp_ERRNO__with_rcq",
		from_cm_event__peer_create_qp_ERRNO, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	{"from_cm_event__create_qp_ERRNO_subsequent_ERRNO2__without_rcq",
		from_cm_event__create_qp_ERRNO_subsequent_ERRNO2, NULL, NULL,
		NULL},
	{"from_cm_event__create_qp_ERRNO_subsequent_ERRNO2__with_rcq",
		from_cm_event__create_qp_ERRNO_subsequent_ERRNO2, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	{"from_cm_event__malloc_ERRNO__without_rcq",
		from_cm_event__malloc_ERRNO, NULL, NULL, NULL},
	{"from_cm_event__malloc_ERRNO__with_rcq",
		from_cm_event__malloc_ERRNO, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	{"from_cm_event__malloc_ERRNO_subsequent_ERRNO2__without_rcq",
		from_cm_event__malloc_ERRNO_subsequent_ERRNO2, NULL, NULL,
		NULL},
	{"from_cm_event__malloc_ERRNO_subsequent_ERRNO2__with_rcq",
		from_cm_event__malloc_ERRNO_subsequent_ERRNO2, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	{"from_cm_event__private_data_store_E_NOMEM__without_rcq",
		from_cm_event__private_data_store_E_NOMEM, NULL, NULL, NULL},
	{"from_cm_event__private_data_store_E_NOMEM__with_rcq",
		from_cm_event__private_data_store_E_NOMEM, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	/* rpma_conn_req_from_cm_event()/_delete() lifecycle */
	{"conn_req_from_cm__lifecycle__without_rcq",
		conn_req_from_cm__lifecycle, setup__conn_req_from_cm_event,
		teardown__conn_req_from_cm_event, NULL},
	{"conn_req_from_cm__lifecycle__with_rcq",
		conn_req_from_cm__lifecycle, setup__conn_req_from_cm_event,
		teardown__conn_req_from_cm_event, &Conn_req_conn_cfg_custom},
};
