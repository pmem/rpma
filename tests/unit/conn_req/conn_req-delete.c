...
static const struct CMUnitTest test_delete[] = {
	...
	cmocka_unit_test(
		delete_via_reject__rcq_delete_ERRNO_subsequent_ERRNO2),
	{"delete_via_reject__cq_delete_ERRNO__without_rcq",
		delete_via_reject__cq_delete_ERRNO, NULL, NULL, NULL},
	{"delete_via_reject__cq_delete_ERRNO__with_rcq",
		delete_via_reject__cq_delete_ERRNO, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	{"delete_via_reject__cq_delete_ERRNO_subsequent_ERRNO2__without_rcq",
		delete_via_reject__cq_delete_ERRNO_subsequent_ERRNO2, NULL,
		NULL, NULL},
	{"delete_via_reject__cq_delete_ERRNO_subsequent_ERRNO2__with_rcq",
		delete_via_reject__cq_delete_ERRNO_subsequent_ERRNO2, NULL,
		NULL, &Conn_req_conn_cfg_custom},
	{"delete_via_reject__reject_ERRNO__without_rcq",
		delete_via_reject__reject_ERRNO, NULL, NULL, NULL},
	{"delete_via_reject__reject_ERRNO__with_rcq",
		delete_via_reject__reject_ERRNO, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	{"delete_via_reject__reject_ERRNO_ack_ERRNO2__without_rcq",
		delete_via_reject__reject_ERRNO_ack_ERRNO2, NULL, NULL, NULL},
	{"delete_via_reject__reject_ERRNO_ack_ERRNO2__with_rcq",
		delete_via_reject__reject_ERRNO_ack_ERRNO2, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	{"delete_via_reject__ack_ERRNO__without_rcq",
		delete_via_reject__ack_ERRNO, NULL, NULL, NULL},
	{"delete_via_reject__ack_ERRNO__with_rcq",
		delete_via_reject__ack_ERRNO, NULL, NULL,
		&Conn_req_conn_cfg_custom},
	/* delete via rdma_destroy_id() */
	cmocka_unit_test(delete_via_destroy__rcq_delete_ERRNO),
	cmocka_unit_test(
		delete_via_destroy__rcq_delete_ERRNO_subsequent_ERRNO2),
	{"delete_via_destroy__cq_delete_ERRNO__without_rcq",
		delete_via_destroy__cq_delete_ERRNO, NULL, NULL, NULL},
	{"delete_via_destroy__cq_delete_ERRNO__with_rcq",
		delete_via_destroy__cq_delete_ERRNO, NULL, NULL,
		&Conn_req_new_conn_cfg_custom},
	{"delete_via_destroy__cq_delete_ERRNO_subsequent_ERRNO2__without_rcq",
		delete_via_destroy__cq_delete_ERRNO_subsequent_ERRNO2,
		NULL, NULL, NULL},
	{"delete_via_destroy__cq_delete_ERRNO_subsequent_ERRNO2__with_cq",
		delete_via_destroy__cq_delete_ERRNO_subsequent_ERRNO2,
		NULL, NULL, &Conn_req_new_conn_cfg_custom},
	{"delete_via_destroy__destroy_id_ERRNO__without_rcq",
		delete_via_destroy__destroy_id_ERRNO, NULL, NULL, NULL},
	{"delete_via_destroy__destroy_id_ERRNO__with_rcq",
		delete_via_destroy__destroy_id_ERRNO, NULL, NULL,
		&Conn_req_new_conn_cfg_custom},
