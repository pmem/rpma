...
{
	/* run test */
	int ret = rpma_write_atomic_cmp_swp(NULL, MOCK_RPMA_MR_REMOTE,
			MOCK_OFFSET_ALIGNED, MOCK_RPMA_MR_LOCAL,
			MOCK_LOCAL_OFFSET, MOCK_FLAGS, MOCK_COMPARE,
...
/*
 * write_atomic_cmp_swp__dst_NULL -- NULL dst is invalid
 */
static void
write_atomic_cmp_swp__dst_NULL(void **unused)
{
	/* run test */
	int ret = rpma_write_atomic_cmp_swp(MOCK_CONN, NULL,
			MOCK_OFFSET_ALIGNED, MOCK_RPMA_MR_LOCAL,
			MOCK_LOCAL_OFFSET, MOCK_FLAGS, MOCK_COMPARE,
			MOCK_SWAP, MOCK_OP_CONTEXT);
...
/*
 * write_atomic_cmp_swp__src_NULL -- NULL src is invalid
 */
static void
write_atomic_cmp_swp__src_NULL(void **unused)
{
	/* run test */
	int ret = rpma_write_atomic_cmp_swp(MOCK_CONN, MOCK_RPMA_MR_REMOTE,
...
write_atomic_cmp_swp__flags_0(void **unused)
{
	...
	int ret = rpma_write_atomic_cmp_swp(MOCK_CONN, MOCK_RPMA_MR_REMOTE,
			MOCK_OFFSET_ALIGNED, MOCK_RPMA_MR_LOCAL,
			MOCK_LOCAL_OFFSET, 0, MOCK_COMPARE, MOCK_SWAP,
			MOCK_OP_CONTEXT);
...
/*
 * write_atomic_cmp_swp__dst_offset_unaligned -- the unaligned
 * dst_offset is invalid
 */
static void
write_atomic_cmp_swp__dst_offset_unaligned(void **unused)
{
	/* run test */
	int ret = rpma_write_atomic_cmp_swp(MOCK_CONN, MOCK_RPMA_MR_REMOTE,
...
/*
 * write_atomic_cmp_swp__all_invalid_arguments -- NULL conn, dst, src,
...
{
	/* run test */
	int ret = rpma_write_atomic_cmp_swp(NULL, NULL, MOCK_REMOTE_OFFSET,
			NULL, MOCK_LOCAL_OFFSET, 0, MOCK_COMPARE,
			MOCK_SWAP, MOCK_OP_CONTEXT);
...
write_atomic_cmp_swp__success(void **cstate_ptr)
{
	...
	expect_value(rpma_mr_atomic_cmp_swp, dst, MOCK_RPMA_MR_REMOTE);
	expect_value(rpma_mr_atomic_cmp_swp, dst_offset, MOCK_OFFSET_ALIGNED);
	expect_value(rpma_mr_atomic_cmp_swp, src, MOCK_RPMA_MR_LOCAL);
	expect_value(rpma_mr_atomic_cmp_swp, src_offset, MOCK_LOCAL_OFFSET);
	expect_value(rpma_mr_atomic_cmp_swp, len, RPMA_ATOMIC_WRITE_ALIGNMENT);
	...
	int ret = rpma_write_atomic_cmp_swp(cstate->conn,
			...
			MOCK_FLAGS, MOCK_COMPARE, MOCK_SWAP,
			MOCK_OP_CONTEXT);
...
static const struct CMUnitTest tests_write_atomic_cmp_swp[] = {
	...
	cmocka_unit_test(write_atomic_cmp_swp__dst_NULL),
	cmocka_unit_test(write_atomic_cmp_swp__src_NULL),
	cmocka_unit_test(write_atomic_cmp_swp__flags_0),
	cmocka_unit_test(write_atomic_cmp_swp__dst_offset_unaligned),
	cmocka_unit_test(
		write_atomic_cmp_swp__all_invalid_arguments),
