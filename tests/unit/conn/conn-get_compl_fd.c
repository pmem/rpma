...
/*
 * get_compl_fd__without_rcq -- rcq is NULL
 */
static void
get_compl_fd__without_rcq(void **cstate_ptr)
{
	struct conn_test_state *cstate = *cstate_ptr;
...
static const struct CMUnitTest tests_get_compl_fd[] = {
	...
	cmocka_unit_test_prestate_setup_teardown(
		get_compl_fd__without_rcq, setup__conn_new,
		teardown__conn_delete, &Conn_without_rcq),
	cmocka_unit_test_prestate_setup_teardown(
		get_compl_fd__success, setup__conn_new,
		teardown__conn_delete, &Conn_with_rcq),
