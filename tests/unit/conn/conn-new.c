...
delete__flush_delete_E_PROVIDER(void **unused)
{
	...
	will_return_maybe(rpma_cq_destroy, MOCK_OK);
...
/*
 * delete__cq_destroy_cq_EAGAIN - rpma_cq_destroy() fails with EAGAIN
 */
static void
delete__cq_destroy_EAGAIN(void **unused)
{
	/*
	 * Cmocka does not allow freeing an object in a test if the object was
	 * created in the setup step whereas even failing rpma_conn_delete()
...
/*
 * delete__cq_destroy_EAGAIN_subsequent_EIO -- rdma_destroy_id()
 * fails with EIO after rpma_cq_destroy() fails with EAGAIN
 */
static void
delete__cq_destroy_EAGAIN_subsequent_EIO(void **unused)
{
	/*
	 * Cmocka does not allow freeing an object in a test if the object was
	 * created in the setup step whereas even failing rpma_conn_delete()
...
static const struct CMUnitTest tests_new[] = {
	...
	cmocka_unit_test(delete__cq_destroy_EAGAIN),
	cmocka_unit_test(delete__cq_destroy_EAGAIN_subsequent_EIO),
