...
/* rpma_mr_get_ptr() unit test */

/*
 * get_ptr__mr_NULL - NULL mr is invalid
 */
static void get_ptr__mr_NULL(void **unused)
{
	void *ptr = NULL;
 ...
 */
static void get_ptr__desc_NULL(void **pprestate)
{
	struct prestate *prestate = *pprestate;
	struct rpma_mr_local *mr = prestate->mr;
...
/*
 * get_ptr__mr_NULL_ptr_NULL - NULL mr and NULL ptr are invalid
 */
static void get_ptr__mr_NULL_desc_NULL(void **unused)
{
	/* run test */
 ...
 */
static void get_ptr__success(void **pprestate)
{
	struct prestate *prestate = *pprestate;
	struct rpma_mr_local *mr = prestate->mr;
	void *ptr = NULL;
...
static const struct CMUnitTest tests_descriptor[] = {
	...
	cmocka_unit_test_prestate_setup_teardown(
		...
		teardown__dereg_success,
		&prestate),
	cmocka_unit_test(get_ptr__mr_NULL_desc_NULL),
	cmocka_unit_test_prestate_setup_teardown(
		get_ptr__success,
		setup__reg_success,
		teardown__dereg_success,
