...
/*
 * atomic_write__success_COMPLETION_ALWAYS - happy day scenario
 */
static void
atomic_write__success_COMPLETION_ALWAYS(void **mrs_ptr)
{
	struct mrs *mrs = (struct mrs *)*mrs_ptr;
...
/*
 * atomic_write__success_COMPLETION_ON_ERROR
 */
static void
atomic_write__success_COMPLETION_ON_ERROR(void **mrs_ptr)
{
	struct mrs *mrs = (struct mrs *)*mrs_ptr;
...
static const struct CMUnitTest tests_mr__atomic_write[] = {
	...
	cmocka_unit_test_setup_teardown(
			...
			teardown__mr_local_and_remote),
	cmocka_unit_test_setup_teardown(
			atomic_write__success_COMPLETION_ALWAYS,
			setup__mr_local_and_remote,
			teardown__mr_local_and_remote),
	cmocka_unit_test_setup_teardown(
			atomic_write__success_COMPLETION_ON_ERROR,
