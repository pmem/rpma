...
/*
 * test_create_id_failed_E_PROVIDER - rdma_create_id fails with RPMA_E_PROVIDER
 */
static void
test_create_id_failed_E_PROVIDER(void **unused)
{
	/* configure mocks */
...
main(int argc, char *argv[])
{
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test(test_create_id_failed_E_PROVIDER),
