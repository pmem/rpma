...
function(add_test_generic)
	...
	if("${TEST_SCRIPT}" STREQUAL "")
		if(TEST_GROUP_SCRIPT)
			set(cmake_script ${CMAKE_CURRENT_SOURCE_DIR}/../run_group.cmake)
		elseif("${TEST_CASE}" STREQUAL "")
			set(TEST_CASE "0")
...
function(add_multithreaded)
	...
	add_test_generic(NAME ${target} GROUP_SCRIPT CASE 0)
endfunction()
