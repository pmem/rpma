...
typedef int (*mtt_thread_seq_init)(void *prestate, void **thread_state_ptr,
		unsigned tid);
typedef void (*mtt_thread_init)(void *prestate, void **thread_state_ptr,
		unsigned tid, struct mtt_thread_result *tr);
typedef void (*mtt_thread_func)(void *prestate, void *thread_state,
		struct mtt_thread_result *tr);
typedef void (*mtt_thread_fini)(void **thread_state,
		struct mtt_thread_result *tr);
typedef int (*mtt_thread_seq_fini)(void **thread_state);
