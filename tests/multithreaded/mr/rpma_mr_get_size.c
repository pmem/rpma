 ...
 * allocate memory region, register the memory and get the memory region size
 */
static void
prestate_init(void *prestate, struct mtt_result *tr)
{
	...
	ret = rpma_mr_get_size(pr->mr, &pr->mr_size_exp);
	if (ret) {
...
/*
 * prestate_fini -- deregister the memory region, free it and delete the peer object
 */
static void
