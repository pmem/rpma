...
/*
 * cm_event_setup -- setup test environment with a valid cm_event
 */
static int
...
/*
 * new_test_1st_malloc_ENOMEM -- the first malloc() fail with ENOMEM
 */
static void
...
/*
 * new_test_2nd_malloc_ENOMEM -- the second malloc() fail with ENOMEM
 */
static void
