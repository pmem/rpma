...
info_active_setup(void **info_ptr)
{
	...
	/* setup */
	int ret = rpma_info_new(MOCK_NODE, MOCK_SERVICE, RPMA_INFO_ACTIVE,
			(struct rpma_info **)info_ptr);
	assert_int_equal(ret, 0);
	assert_non_null(*info_ptr);
...
/*
 * info_resolve_addr_test_id_eq_NULL -- NULL id is invalid
 */
static void
info_resolve_addr_test_id_eq_NULL(void **info_ptr)
{
	/* run test */
...
/*
 * info_resolve_addr_test_info_eq_NULL -- NULL info is invalid
 */
static void
info_resolve_addr_test_info_eq_NULL(void **unused)
{
	/* run test */
...
/*
 * info_resolve_addr_test_id_and_info_eq_NULL -- NULL id and info are invalid
 */
static void
info_resolve_addr_test_id_and_info_eq_NULL(void **info_ptr)
{
	/* run test */
...
/*
 * info_resolve_addr_test_resolve_addr_fail_EAGAIN -- rdma_resolve_addr() fails
 * with EAGAIN
 */
static void
info_resolve_addr_test_resolve_addr_fail_EAGAIN(void **info_ptr)
{
	/* configure mocks */
	struct rdma_cm_id cmid;
...
/*
 * info_bind_addr_test_id_eq_NULL -- NULL id is invalid
 */
static void
info_bind_addr_test_id_eq_NULL(void **info_ptr)
{
	/* run test */
...
/*
 * info_bind_addr_test_info_eq_NULL -- NULL info is invalid
 */
static void
info_bind_addr_test_info_eq_NULL(void **unused)
{
	/* run test */
	struct rdma_cm_id cmid;
...
/*
 * info_bind_addr_test_id_and_info_eq_NULL -- NULL id and info are invalid
 */
static void
info_bind_addr_test_id_and_info_eq_NULL(void **info_ptr)
{
	/* run test */
...
/*
 * info_bind_addr_test_bind_addr_fail_EAGAIN -- rpma_info_bind_addr() fails
 * with EAGAIN
 */
static void
info_bind_addr_test_bind_addr_fail_EAGAIN(void **info_ptr)
{
	/* configure mocks */
	struct rdma_cm_id cmid;
...
main(int argc, char *argv[])
{
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test_setup_teardown(
				info_resolve_addr_test_id_eq_NULL,
				info_active_setup, info_teardown),
		cmocka_unit_test(info_resolve_addr_test_info_eq_NULL),
		cmocka_unit_test(info_resolve_addr_test_id_and_info_eq_NULL),
		cmocka_unit_test_setup_teardown(
				info_resolve_addr_test_resolve_addr_fail_EAGAIN,
				info_active_setup, info_teardown),
		cmocka_unit_test_setup_teardown(
		...
		cmocka_unit_test_setup_teardown(
				info_bind_addr_test_id_eq_NULL,
				info_passive_setup, info_teardown),
		cmocka_unit_test(info_bind_addr_test_info_eq_NULL),
		cmocka_unit_test(info_bind_addr_test_id_and_info_eq_NULL),
		cmocka_unit_test_setup_teardown(
				info_bind_addr_test_bind_addr_fail_EAGAIN,
				info_passive_setup, info_teardown),
		cmocka_unit_test_setup_teardown(
