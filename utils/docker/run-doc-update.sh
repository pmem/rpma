...
UPSTREAM_RPMA="https://github.com/pmem/rpma"

# set up the rpma repo
set_up_repo ${ORIGIN_RPMA} ${UPSTREAM_RPMA} rpma ${TARGET_BRANCH}
...
cd ${WORKDIR}/rpma
BRANCH_PR="man-pages-for-${TARGET_BRANCH}"
git checkout -B $BRANCH_PR upstream/man-pages
git clean -dfx
